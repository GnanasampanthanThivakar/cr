                    ...
                    <div className="flex flex-col gap-11">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-secondary-text/70 dark:text-white/70">Minor dents up to 2 inches in diameter</p>
                                <p className="text-2xl font-bold text-primary">AED 150</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Medium Dents</h3>
                                <p className="text-secondary-text/70 dark:text-white/70">Dents up to 4 inches, multiple locations</p>
                                <p className="text-2xl font-bold text-primary">AED 300</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Large Panel</h3>
                                <p className="text-secondary-text/70 dark:text-white/70">Major dent repair for entire panels</p>

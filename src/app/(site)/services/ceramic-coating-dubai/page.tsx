                    ...
                    <div className="flex flex-col gap-11">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-secondary/70 dark:text-white/70">Single layer ceramic coating with 2-year warranty</p>
                                <p className="text-2xl font-bold text-primary">AED 1,500</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Premium Package</h3>
                                <p className="text-secondary/70 dark:text-white/70">Multi-layer ceramic coating with 5-year warranty</p>
                                <p className="text-2xl font-bold text-primary">AED 3,000</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Ultimate Package</h3>
                                <p className="text-secondary/70 dark:text-white/70">Professional-grade ceramic coating with lifetime warranty</p>

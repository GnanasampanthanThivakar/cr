                    ...
                    <div className="flex flex-col gap-11">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-secondary/70 dark:text-white/70">Exterior cleaning and degreasing</p>
                                <p className="text-2xl font-bold text-primary">AED 200</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Deep Clean</h3>
                                <p className="text-secondary/70 dark:text-white/70">Complete detailing with protection coating</p>
                                <p className="text-2xl font-bold text-primary">AED 350</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Show Quality</h3>
                                <p className="text-secondary/70 dark:text-white/70">Competition-level detailing and protection</p>

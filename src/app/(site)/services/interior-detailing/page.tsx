                    ...
                    <div className="flex flex-col gap-11">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-secondary/70 dark:text-white/70">Vacuum, wipe down, and basic cleaning</p>
                                <p className="text-2xl font-bold text-primary">AED 250</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Deep Clean</h3>
                                <p className="text-secondary/70 dark:text-white/70">Steam cleaning, leather conditioning</p>
                                <p className="text-2xl font-bold text-primary">AED 450</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Premium Interior</h3>
                                <p className="text-secondary/70 dark:text-white/70">Complete restoration with protection</p>

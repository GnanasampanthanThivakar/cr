                    ...
                    <div className="flex flex-col gap-11">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-secondary-text/70 dark:text-white/70">Front bumper, hood, and mirrors protection</p>
                                <p className="text-2xl font-bold text-primary">AED 2,500</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Full Front</h3>
                                <p className="text-secondary-text/70 dark:text-white/70">Complete front end protection including headlights</p>
                                <p className="text-2xl font-bold text-primary">AED 4,500</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Full Body PPF</h3>
                                <p className="text-secondary-text/70 dark:text-white/70">Complete vehicle protection with 10-year warranty</p>

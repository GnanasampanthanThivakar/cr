                    ...
                    <div className="flex flex-col gap-11">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="text-secondary/70 dark:text-white/70">Complete repair for one damaged wheel</p>
                                <p className="text-2xl font-bold text-primary">AED 300</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Set of 4 Wheels</h3>
                                <p className="text-secondary/70 dark:text-white/70">Repair all four wheels with discount</p>
                                <p className="text-2xl font-bold text-primary">AED 1,000</p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <h3 className="text-xl font-bold">Diamond Cut Refinish</h3>
                                <p className="text-secondary/70 dark:text-white/70">Complete refinishing for diamond cut wheels</p>

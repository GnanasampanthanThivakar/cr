                ...
                <div className="flex flex-col 2xl:flex-row gap-10 2xl:gap-28">
                    <div className="flex flex-col gap-5 2xl:gap-7 w-full 2xl:max-w-2xl 2xl:w-full">
                        ...
                        <div className="flex flex-col gap-5 2xl:gap-7">
                            <h2 className="2xl:max-w-3xl text-secondary dark:text-white">Why Choose Crystal Shine</h2>
                            <p className="2xl:max-w-sm text-secondary/70 dark:text-white/70">Dubai's premier car detailing center since 2009, combining XPEL-certified expertise with premium products for showroom-perfect results.</p>
                        </div>
                    </div>
                    <div className="grid md:grid-cols-3 gap-5 2xl:gap-7">
                        <div className="relative bg-primary p-4 2xl:p-7 flex flex-col justify-between gap-8 md:gap-0">
                            <div className="relative z-10 flex flex-col gap-2 lg:gap-4">
                                ...
                                <p className="dark:text-secondary">Crystal Shine transformed my BMW with professional ceramic coating. The finish is incredible!</p>
                            </div>
                            <div className="relative z-10">
                                <div className="relative border-b border-secondary/12 pb-5">
                                    <h2 className="dark:text-secondary">100%</h2>
                                ...
                                <div className="flex items-center gap-2 lg:gap-5 pt-5">
                                    ...
                                    <div>
                                        <p className="font-medium dark:text-secondary">Ahmed Al Mansoori</p>
                        ...
                        <div className="flex flex-col gap-5 2xl:gap-7">
                            ...
                            <div className="bg-secondary dark:bg-lightgray/10 p-5 2xl:p-7 flex flex-col justify-between gap-8">
                                <div>
                                    <h2 className="text-white">10,000+</h2>
                                    <p className="text-base text-white/70">Vehicles detailed since 2009</p>
                                </div>
                                <div>
                        ...
                        <div className="relative overflow-hidden p-5 2xl:p-7 border border-secondary/12 dark:border-white/30 flex flex-col justify-between gap-8 md:gap-0">
                            ...
                            <div className="flex flex-col gap-4 relative z-10">
                                ...
                                <p>Dubai's premier car detailing destination, serving luxury and everyday vehicles with XPEL-certified expertise and premium products.</p>
                            </div>

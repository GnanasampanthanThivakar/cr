            ...
            <div className="container">
                                ...
                                <div>
                                    {!loader ? (
                                        <button type="submit" className="group relative flex justify-center items-center w-full bg-primary hover:bg-secondary rounded-full transition-all duration-300 ease-in-out cursor-pointer">
                                            <span className="py-4 px-2 text-lg font-bold text-secondary group-hover:text-white transition-all duration-300 ease-in-out">Send Message</span>
                ...
                <div className="mt-16 text-center">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-secondary font-bold py-3 px-6 rounded-full transition-colors"
                    >

                ...
                <div className="container">
                    <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                        <div className="flex items-center py-3 gap-4 md:gap-8 w-full max-w-xl">
                            <span className="bg-primary py-1.5 px-2.5 text-base font-medium rounded-full dark:text-secondary-text">{statsFactData && statsFactData?.number}</span>
                        ...
                        <div className="flex flex-col gap-11">
                            <div className="flex flex-col gap-5 ">
                                ...
                                <p className="max-w-xl text-secondary-text/70 dark:text-white/70">{statsFactData?.description}</p>
                            </div>
                                ...
                                {statsFactData && statsFactData?.scoreData?.map((value: any, index: any) => {
                                    return (
                                        <div ref={ref} key={index} className="flex flex-col gap-5 pt-4 md:pt-11 border-t border-secondary/12 dark:border-white/12">
                                            ...
                                            <p className="text-base text-secondary-text/70 dark:text-white/70">{value.scoreDescp}</p>
                                        </div>
                                    )
                                })}
                            </div>

                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    ...
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">Real experiences from Dubai's car owners who trust Crystal Shine with their prized vehicles.</p>
                                </div>
                            </div>
                        </div>
